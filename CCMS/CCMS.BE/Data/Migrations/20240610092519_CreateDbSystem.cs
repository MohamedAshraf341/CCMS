...
{
    public partial class CreateDbSystem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpdateOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UpdateOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UpdateOrders_Updates_UpdateId",
                        column: x => x.UpdateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpdateOrders_OrderId",
                table: "UpdateOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdateOrders_UpdateId",
                table: "UpdateOrders",
                column: "UpdateId");
        }
